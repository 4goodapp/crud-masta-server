...
<html>
	...
	<body>
		<a href="#edit-province" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-province" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:provinceInstance, action:'update']" method="PUT" >
